...
export type textComponentProps = TextComponentProps;

interface ImageComponentProps extends CommonComponentProps {
  src: string;
}
export type imageComponentProps = ImageComponentProps;

export interface ShapeComponentProps extends CommonComponentProps {
  backgroundColor: string;
}
export type shapeComponentProps = ShapeComponentProps;
